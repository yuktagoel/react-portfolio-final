...
const SocialIcons = (props) => {
    return (
        <Icons>
            ...
            >
                <NavLink style={{color:'inherit'}}  target="_blank"   to={{pathname:"https://github.com/yuktagoel"}}>
            ...
            <motion.div
            initial={{transform:"scale(0)"}}Gmail
            animate={{scale:[0,1,1.5,1]}}
            transition={{type:'spring', duration:1, delay:1.4}}
            >
                <NavLink style={{color:'inherit'}}target="_blank" to={{pathname:"mailto:yukta.goyal25@gmail.com"}}>
